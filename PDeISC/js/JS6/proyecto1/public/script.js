document.addEventListener('DOMContentLoaded', () => {
    ...
    function actualizarListaNumeros() {
        ...
        if (numerosIngresados.length >= MAX_NUMEROS) {
            ...
            inputNumero.value = '';
            // Solo muestra el mensaje si el contador no ha sido ya actualizado por otra acción (ej. agregar número)
            if (!mensajeErrorP.textContent.includes(`alcanzado el número máximo`)) {
